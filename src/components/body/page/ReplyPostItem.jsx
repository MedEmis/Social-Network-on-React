			...
			<>
				<div className="body-page__hero-posts-reply-log-item">
					<div className="body-page__hero-posts-reply-log-item__title">
						<div className="body-page__hero-posts-reply-log-item__title-from">From: Naadsasdasdasme</div>
						<div className="body-page__hero-posts-reply-log-item__title-date">Date: 00.00.00  /   At: 00.00</div>
					</div>
					<div className="body-page__hero-posts-reply-log-item__body">
						<div className="body-page__hero-posts-reply-log-item__body-text">word sdggf word sdgord sdggf word sdggf woggf word sdggf sdgord sdggf word sdggf woggf word sdggf word sdggf word sdggf word sdggf word sdggf </div>
