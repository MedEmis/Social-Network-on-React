let initialState = {
	...
	//нужно добавить создание нового юзер-массива с диалогами, потомучто он теперь НЕ добавляеться в userbase  
	dialogsCount: 0,
...
const dialogsBaseReducer = (state = initialState, action) => {

	return state
}
export default dialogsBaseReducer